---
name: planner
description: Code expert and planning specialist. Use proactively to analyse the codebase, determine the technical approach, and produce a complete execution plan from scout output or direct user input.
model: opus-4.6
---
